                     ...
                     SendDestination option, time::milliseconds imsFresh)
{
 ...
 printf("--------------------Dispatcher::sendData to IMS--------------------------\n");
    ...
    printf("Dispatcher:Insert finished!\n");
  }

  if (option == SendDestination::FACE || option == SendDestination::FACE_AND_IMS) {
 printf("--------------------Dispatcher::sendData to FACE--------------------------\n");
    sendOnFace(*data);
  }
}
...
{printf("------------------processControlCommandInterest--------------------\n");
...
{  printf("--------------------Dispatcher:processAuthorizedControlCommandInterest------------------\n");
...
{
  printf("--------------------Dispatcher:sendControlResponse------------------\n");
  MetaInfo metaInfo;
  if (isNack) {
...
{
  printf("--------------------Dispatcher:addStatusDataset------------------\n");
...
Dispatcher::processStatusDatasetInterest(const Name& prefix,
                                         ...
                                         const AuthorizationAcceptedCallback& accepted,
                                         const AuthorizationRejectedCallback& rejected)
{ printf("--------------------Dispatcher:processStatusDatasetInterest------------------\n");
...
{
 printf("--------------------Dispatcher:processAuthorizedStatusDatasetInterest------------------\n");
                                     ...
                                     time::milliseconds imsFresh, bool isFinalBlock)
{
 ...
 printf("--------------------Dispatcher:sendStatusDatasetSegment------------------\n");
...
{
 printf("--------------------Dispatcher:postNotification------------------\n");
